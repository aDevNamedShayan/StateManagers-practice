...
import { useLikeComment } from './../../../core/services/api/Courses/CourseComment/LikeComment';
...
const CourseCommentsModal = ({ isOpen, onClose, courseComments, dataBlog }) => {
  ...
  const handleLike = async (id) => {
    ...
    try {
      ...
      toast.success("تایید کامنت با موفقیت شد!", {position: "top-center"});
              ...
              <div className="flex items-start space-x-2">
                <div className="flex-1">
                  ...
                  <div className="flex gap-3 space-x-2">
                    <div className="text-sm text-black hover:text-green-500 dark:text-gray-400 dark:hover:text-green-400 flex items-center gap-1"  onClick={() => handleLike(comment.id)}>
                      <svg
                        width="22"
                        height="22"
                        viewBox="0 0 24 24"
                    ...
                    <div className="text-sm text-black hover:text-green-500 dark:text-gray-400 dark:hover:text-green-400 flex items-center gap-1">
                      ...
                      {digitsEnToFa(isCourseComment ? comment.disslikeCount : comment.dissLikeCount)}
                    </div>
                    {isReplyOpen ? (
                      <>
                        {addComment()}
